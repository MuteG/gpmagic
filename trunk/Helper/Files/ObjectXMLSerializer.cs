...
namespace GPSoft.Helper.Files
{
    ...
    /// </summary>
    public static class ObjectXMLSerialize<T> where T : class // Specify that T must be a class.
    {
        #region Load methods
        ...
        public static T Load(T serializableObject, string path)
        {
        ...
        public static T Load(T serializableObject, string path, SerializeFormats serializedFormat)
        {
            switch (serializedFormat)
            {
                ...
                case SerializeFormats.Document:
                default:
                    serializableObject = LoadFromDocumentFormat(serializableObject, null, path, null);
                    break;
            }
        ...
        /// <returns>Object loaded from an XML file in Document format.</returns>
        public static T Load(T serializableObject, string path, System.Type[] extraTypes)
        {
        ...
        public static T Load(T serializableObject, string fileName, IsolatedStorageFile isolatedStorageDirectory, SerializeFormats serializedFormat)
        {
            switch (serializedFormat)
            {
                case SerializeFormats.Binary:
        ...
        /// <param name="extraTypes">Extra data types to enable deserialization of custom types within the object.</param>
        /// <returns>Object loaded from an XML file located in a specified isolated storage area, using a specified serialized format.</returns>
        public static T Load(T serializableObject, string fileName, IsolatedStorageFile isolatedStorageDirectory, System.Type[] extraTypes)
        {
            serializableObject = LoadFromDocumentFormat(serializableObject, null, fileName, isolatedStorageDirectory);
            return serializableObject;
        }
        ...
        public static void Save(T serializableObject, string path, SerializeFormats serializedFormat)
        {
            switch (serializedFormat)
            {
                case SerializeFormats.Binary:
        ...
        /// <param name="isolatedStorageDirectory">Isolated storage area directory containing the XML file to save the object to.</param>
        /// <param name="serializedFormat">XML serialized format used to save the object.</param>        
        public static void Save(T serializableObject, string fileName, IsolatedStorageFile isolatedStorageDirectory, SerializeFormats serializedFormat)
        {
            switch (serializedFormat)
            {
                case SerializeFormats.Binary:
        ...
        private static T LoadFromBinaryFormat(T serializableObject, string path, IsolatedStorageFile isolatedStorageFolder)
        {
        ...
        private static T LoadFromDocumentFormat(T serializableObject, System.Type[] extraTypes, string path, IsolatedStorageFile isolatedStorageFolder)
        {
        ...
        private static XmlSerializer CreateXmlSerializer(T serializableObject, System.Type[] extraTypes)
        {
